...
<link rel="StyleSheet" href="/okozukai/css/userRegistComplete.css" type="text/css">
				...
				<div id="contents">
					...
					<table class="input_userinfo">
						<tr>
							...
							<td><bean:write name="UserRegistActionForm" property="userId" scope="request" /></td>
						</tr>
						<tr>
							<td class="input_userinfo_head" align="left">パスワード</td>
							<td><bean:write name="UserRegistActionForm" property="userPassword" scope="request" /></td>
						</tr>
					</table>
					<!-- ボタンエリア -->
